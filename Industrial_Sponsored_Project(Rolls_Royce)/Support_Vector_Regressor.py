##### This kernel will showcase how to import a dataset and use the Support Vector Regressor algorithm (Regression) on it
...
### Import the Support Vector Regressor Regressor library
from sklearn.svm import SVR

# Create a Support Vector Regressor Regressor object and tune it accordingly
regressor=SVR(kernel='rbf', C=1, gamma=10000, epsilon=0.03)

# Then, fit the Regressor with the training data to create a model
regressor.fit(train_features,train_labelss)
