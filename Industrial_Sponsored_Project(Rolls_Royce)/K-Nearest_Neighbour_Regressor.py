##### This kernel will showcase how to import a dataset and use the K-Nearest Neighbour algorithm (Regression) on it
...
### Import the K_Nearest Neighbour Regressor library
from sklearn import neighbors

# Create a KNN Regressor object and tune it accordingly
