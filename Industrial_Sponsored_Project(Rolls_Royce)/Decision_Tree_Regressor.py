##### This kernel will showcase how to import a dataset and use the Decision Tree algorithm (Regression) on it
...
### Import the Decision Tree Regressor library
from sklearn.tree import DecisionTreeRegressor

# Create a Decision Tree Regressor object and tune it accordingly
